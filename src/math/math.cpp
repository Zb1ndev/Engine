...
#pragma region Vector2
  ...
  Engine::Vector2 Engine::Vector2::Mul(Engine::Vector2 _a, Engine::Vector2 _b) {
    return Vector2((_a.x * _b.x), (_a.y * _b.y));
  }
  Engine::Vector2 Engine::Vector2::Div(Engine::Vector2 _a, Engine::Vector2 _b) {
    return Vector2((_a.x / _b.x), (_a.y / _b.y));
  }
...
#pragma region Vector2Int
  ...
  Engine::Vector2Int Engine::Vector2Int::Mul(Engine::Vector2Int _a, Engine::Vector2Int _b) {
    return Vector2Int((_a.x * _b.x), (_a.y * _b.y));
  }
  Engine::Vector2Int Engine::Vector2Int::Div(Engine::Vector2Int _a, Engine::Vector2Int _b) {
    return Vector2Int((_a.x / _b.x), (_a.y / _b.y));
  }
